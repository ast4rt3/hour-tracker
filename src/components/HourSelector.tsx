...
const HOURS = [
  { hour: 6, color: '#3B82F6', bgLight: 'rgba(59, 130, 246, 0.1)', label: '6 AM' },
  { hour: 7, color: '#10B981', bgLight: 'rgba(16, 185, 129, 0.1)', label: '7 AM' },
  { hour: 8, color: '#F59E0B', bgLight: 'rgba(245, 158, 11, 0.1)', label: '8 AM' },
  { hour: 9, color: '#F97316', bgLight: 'rgba(249, 115, 22, 0.1)', label: '9 AM' },
  { hour: 10, color: '#EF4444', bgLight: 'rgba(239, 68, 68, 0.1)', label: '10 AM' },
]
